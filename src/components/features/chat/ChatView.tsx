            ...
            >
                {messages.map((msg, i) => (
                    ...
                    >
                        {/* AI avatar */}
                        {msg.role === 'ai' && (
                            <div className="w-7 h-7 rounded-xl bg-blue-600/20 border border-blue-500/20 flex items-center justify-center shrink-0 mb-0.5">
            ...
            <div className="px-4 py-3 border-t border-slate-800 bg-slate-950">
                <div className="flex gap-2 items-center">
                    <input
                        ...
                        disabled={loading}
                        className="flex-1 h-11 bg-slate-800/80 border border-slate-700 rounded-2xl px-4 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 disabled:opacity-60 transition-colors"
                    />
                    <button
                        onClick={() => handleSend()}
