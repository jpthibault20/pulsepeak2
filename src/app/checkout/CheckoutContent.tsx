    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white">
            ...
            <div className="max-w-2xl mx-auto px-4 py-10">
                ...
                <p className="text-slate-400 text-sm mb-8">Vérifiez les détails ci-dessous avant de procéder au paiement.</p>
                ...
                <div className="grid grid-cols-1 gap-6">
                    ...
                    <div className="bg-slate-900 border border-slate-700 rounded-2xl p-5">
                        ...
                        <div className="bg-slate-800/60 rounded-xl p-3 flex items-center justify-between">
                            <span className="text-slate-300 text-sm font-medium">Total mensuel</span>
                            <span className="text-white font-bold">{plan.price}/mois</span>
                        </div>
                    </div>

                    {/* ── Informations de facturation (placeholder) ──────── */}
                    <div className="bg-slate-900 border border-slate-700 rounded-2xl p-5">
                        <h2 className="text-white font-semibold text-sm mb-4">Informations de facturation</h2>
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <input
                                    ...
                                    disabled
                                    className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2.5 text-sm text-slate-400 placeholder-slate-600 cursor-not-allowed"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                <label className="block text-slate-400 text-xs mb-1.5">Carte bancaire</label>
                                <div className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2.5 flex items-center gap-2">
                                    <CreditCard size={14} className="text-slate-600" />
                                    <span className="text-slate-600 text-sm">Formulaire Stripe · bientôt disponible</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <button
                            disabled
                            className="w-full flex items-center justify-center gap-2.5 bg-slate-700 text-slate-500 font-semibold py-4 rounded-2xl text-sm cursor-not-allowed border border-slate-600"
                        >
                            <Lock size={15} />
                            Payer {plan.price}/mois avec Stripe
                            <span className="text-slate-600 text-xs font-normal ml-1">(intégration en cours)</span>
                        </button>

                        {/* Garanties */}
                        <div className="flex items-center justify-center gap-4 mt-4 text-slate-600 text-xs flex-wrap">
